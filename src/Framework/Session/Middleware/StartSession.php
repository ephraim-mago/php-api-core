...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \Framework\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param  \Framework\Session\SessionManager  $manager
     * @return void
     */
    ...
    protected function getCookieExpirationDate()
    {
        ...
        return $config['expire_on_close'] ? 0 : Date::now()->addMinutes($config['lifetime'])->toDateTime();
    }
